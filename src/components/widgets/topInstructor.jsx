...
export default function TopInstructor({ instr, isVisible }) {
  return (
    <div
      className={`md:col-span-2 md:row-span-2 rounded-4xl p-8 flex flex-col justify-between transition-all duration-500 bg-linear-to-br from-[#1A1F25] to-[#303841] border border-white/10 shadow-2xl relative overflow-hidden group ${
