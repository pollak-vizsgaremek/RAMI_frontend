    ...
    <div className="bg-linear-to-br from-[#1A1F25] to-[#303841] rounded-4xl p-6 flex flex-col justify-between border border-white/10 shadow-2xl group relative overflow-hidden hover:scale-[1.02] duration-300">
      ...
      <div className="mt-4 relative z-10">
        ...
        <button
          ...
          disabled={locLoading}
          className={`w-full py-3 rounded-2xl text-[11px] font-black uppercase tracking-tighter hover:scale-105 active:scale-95 transition-all shadow-lg shadow-[#F6C90E]/20 hover:shadow-[#F6C90E]/40 cursor-pointer ${
            nearestCenter
